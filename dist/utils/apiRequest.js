...
const setApiTournamentsFilters = body => {
  return new Promise((resolve, reject) => {
    ...
    axios.get(url, {
      ...
      const tableColumns = ["@id", "@scheduledStartDate", "@network", "@stake", "@guarantee", "@lateRegEndDate", "@field", "@game", "@name", "@AvAbility", "@TypeAvAbility", "@TypeAvEntrants", "@TypeAvDuration", "@overlay"];
      let finalStatsResponse = [];
      let tempStatsResponse = [];
